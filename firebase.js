...
try {
  ...
  console.error("[Firebase Init] Firebase initialization failed. Please check your configuration.");
  throw e; // Re-throw to ensure the app fails if Firebase can't be initialized
}
